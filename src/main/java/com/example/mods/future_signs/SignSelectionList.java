...
public class SignSelectionList extends GuiListExtended
{
    ...
    public static class Entry implements GuiListExtended.IGuiListEntry
    {
        ...
        {
            TileEntitySign sign = ((GuiEditSignAccessor)((GuiEditSign)this.mc.currentScreen)).tileSign();
            sign.markDirty();

            if (Minecraft.getSystemTime() - this.lastClicked < 250L)
            {
//                if (SkyBlockcatiaSettings.INSTANCE.auctionBidConfirm && NumberUtils.isNumber(this.value))
//                {
